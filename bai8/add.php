<?php
    require './connectdb.php'; // KẾT nối cơ sở dữ liệu
    
    $name = $email = $phone = $addrees = $gender =  '';
    ...
    if(isset($_POST['btn-submit'])) {
        ...
        if ($name != "" && $email != "" && $phone != "" && $addrees != "" && $gender != "") {
            $sql = "INSERT INTO users(name, email, phone, addrees, gender) VALUES('$name', '$email', '$phone', '$addrees', '$gender')";
            $query = $pdo->query($sql);
